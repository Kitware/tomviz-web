...
class PeronaMalikAnisotropicDiffusion(tomviz.operators.CancelableOperator):
    def transform(self, dataset, conductance=1.0, iterations=100, timestep=0.0625):
        ...
        try:
            ...
            itkutils.observe_filter_progress(
                self, diffusion_filter, STEP_PCT[1], STEP_PCT[2]
            )
            ...
            itkutils.set_itk_image_on_dataset(diffusion_filter.GetOutput(), dataset)

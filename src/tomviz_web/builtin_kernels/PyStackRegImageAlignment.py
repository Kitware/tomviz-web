...
from tomviz.utils import depad_array, pad_array
...
def transform_from_file(dataset, transform_file, apply_to_all_arrays=True, axis=0):
    array = dataset.active_scalars
...
def rescale_tmats(tmats, transform_type, shape1, spacing1, padding1, shape2, spacing2):
    ...
    return translate_to_new @ scale_to_new @ tmats @ scale_to_orig @ translate_to_orig

    ...
    def transform(
        ...
        try:
            ...
            erode_filter = itk.BinaryErodeImageFilter[
                itk_input_image_type, itk_input_image_type, itk_kernel_type
            ].New()
            ...
            itkutils.observe_filter_progress(
                self, erode_filter, STEP_PCT[1], STEP_PCT[2]
            )
            ...
            itkutils.observe_filter_progress(
                self, dilate_filter, STEP_PCT[2], STEP_PCT[3]
            )
            ...
            itkutils.set_itk_image_on_dataset(dilate_filter.GetOutput(), dataset)

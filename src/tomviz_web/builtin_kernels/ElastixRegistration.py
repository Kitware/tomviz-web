def transform(
    ...
    disable_rotation,
    interpolator,
    bspline_interpolation_order,
    resample_interpolator,
    resample_bspline_interpolation_order,
    lower_threshold,
    upper_threshold,
    show_elastix_console_output,
):
    try:
        import itk
        import numpy as np
    ...
    default_rigid_parameter_map = parameter_object.GetDefaultParameterMap(method)
